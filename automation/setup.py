...
from BuildRegistrationDefinition import (
    __author__,
    __author_email__,
    __description__,
    __keywords__,
...
setup(
    ...
    long_description=__description__,  # Optional
    ...
    install_requires=["click==7.1.2"],  # Optional
    ...
    entry_points={
        "console_scripts": [
            "BuildRegistrationDefinition=BuildRegistrationDefinition:main"
        ]
    },
